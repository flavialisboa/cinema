...
function comprar() {
    ...
    if (valorTotal == 0) {
        ...
        elem_msg.innerHTML = "Resumo do pedido:<br><br>Você selecionou o filme:<br>" + filme + ", no horário de " + horario + ", no valor de R$ " + valorTotal + ",00. <br>Seu assentos são:<br>" + assentosEscolhidos;
    }
}
